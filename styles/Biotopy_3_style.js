...
function categories_Biotopy_3(feature, value, size, resolution, labelText,
    ...
    switch(valueStr) {
        ...
        case '6430, vodný tok':
            return [ new ol.style.Style({
        fill: new ol.style.Fill({color: 'rgba(83,200,40,1.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth, textAlign, offsetX, offsetY, overflow, repeat)
    })];
        ...
        case 'Intenzifikovaná lúka':
            return [ new ol.style.Style({
        fill: new ol.style.Fill({color: 'rgba(36,216,240,1.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth, textAlign, offsetX, offsetY, overflow, repeat)
    })];
        ...
        case 'Ostatná plocha':
            return [ new ol.style.Style({
        fill: new ol.style.Fill({color: 'rgba(127,81,233,1.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth, textAlign, offsetX, offsetY, overflow, repeat)
    })];
        ...
        case 'Ostatné lesy':
            return [ new ol.style.Style({
        fill: new ol.style.Fill({color: 'rgba(186,116,218,1.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth, textAlign, offsetX, offsetY, overflow, repeat)
    })];
        ...
        case 'Stavba':
            return [ new ol.style.Style({
        fill: new ol.style.Fill({color: 'rgba(23,206,206,1.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth, textAlign, offsetX, offsetY, overflow, repeat)
    })];
